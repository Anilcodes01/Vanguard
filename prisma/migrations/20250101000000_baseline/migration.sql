...
-- CreateIndex
CREATE INDEX "oauth_clients_client_id_idx" ON "auth"."oauth_clients"("client_id" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "oauth_clients_client_id_key" ON "auth"."oauth_clients"("client_id" ASC);
