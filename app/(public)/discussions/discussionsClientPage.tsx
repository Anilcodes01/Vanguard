...
interface DiscussionsClientPageProps {
  initialProjects: ProjectSubmission[];
}

export default function DiscussionsClientPage({
  initialProjects,
}: DiscussionsClientPageProps) {
  const [projects, setProjects] = useState<ProjectSubmission[]>(initialProjects);
