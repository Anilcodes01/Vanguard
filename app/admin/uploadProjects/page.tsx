...
export default async function UploadProjectsPage() {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-[#262626] text-white p-4">
            <div className="w-full max-w-4xl">
                <h1 className="text-4xl font-bold text-center mb-8">Admin Project Upload</h1>
