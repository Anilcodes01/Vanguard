...
import { 
  XCircle, Code2,  Zap, Star, School, Pencil,  
} from "lucide-react";
...
export const ProfilePanel = ({ user }: { user: ProfileData }) => (
  <div className="bg-neutral-900/50 border border-neutral-800 rounded-xl p-6 sticky top-6">
    ...
    <Link href="/settings/profile" className="mt-8 group flex w-full items-center justify-center gap-2 rounded-lg bg-neutral-800/80 px-4 py-2 text-sm text-neutral-400 transition-colors hover:bg-neutral-800 hover:text-neutral-200">
        <Pencil size={14} />
        Edit Profile
    </Link>
  </div>
