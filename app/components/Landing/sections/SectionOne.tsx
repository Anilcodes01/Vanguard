  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen w-full overflow-hidden px-4 md:px-8 py-20 bg-gray-50">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div
          className="absolute bottom-20 right-10 w-96 h-96 bg-orange-400/10 rounded-full blur-3xl animate-pulse"
        ...
        {mounted &&
          codeSnippets.map((snippet, i) => (
            <div
              key={i}
              className="absolute text-[#f59120] font-mono text-sm animate-float"
              style={{
      ...
      <div className="relative z-10 flex flex-col w-full gap-8 items-center justify-center">
        ...
        >
          Turn Daily Practice
          <br />
          <span className="bg-gradient-to-r from-[#f59120] to-orange-600 text-transparent bg-clip-text">
        ...
        >
          A gamified platform for Indian college students to solve daily
          challenges, build a portfolio, and land a verified virtual internship.
        </p>
        ...
        >
          <button
            ...
            className="group relative cursor-pointer rounded-xl px-8 py-4 bg-gradient-to-r from-[#f59120] to-orange-600 text-white font-semibold overflow-hidden transition-all duration-300 hover:shadow-2xl hover:shadow-[#f59120]/50 hover:scale-105 w-full sm:w-auto"
          >
          ...
          <button
            ...
            className="cursor-pointer rounded-xl px-8 py-4 bg-white text-gray-900 font-semibold border border-gray-300 hover:border-[#f59120] transition-all duration-300 hover:bg-gray-50 w-full sm:w-auto"
          >
            Explore Challenges
          </button>
        </div>
