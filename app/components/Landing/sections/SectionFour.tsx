    ...
    <div className="relative min-h-screen w-full overflow-hidden flex items-center justify-center py-20 px-4 sm:px-6 bg-gray-50">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        {mounted && particles.map((particle) => (
          <div
            key={particle.id}
            className="absolute rounded-full bg-green-400/10 animate-float-particle"
            style={{
      ...
      <div className="relative z-10 text-center max-w-5xl">
        <div className="flex justify-center mb-8">
          <div className="relative">
            <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-green-500 to-emerald-600 flex items-center justify-center rotate-12 shadow-2xl shadow-green-500/25">
              <svg className="w-10 h-10 text-white -rotate-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
              </svg>
            </div>
            <div className="absolute inset-0 rounded-2xl border-2 border-green-500/30 animate-ping"></div>
            <div className="absolute inset-0 rounded-2xl border-2 border-green-500/20 animate-ping" style={{ animationDelay: '0.5s' }}></div>
          </div>
        </div>
        ...
        <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-sans font-bold mb-6 tracking-tight">
          ...
          <span className="block mt-2 bg-gradient-to-r from-green-500 via-emerald-500 to-green-600 text-transparent bg-clip-text animate-gradient">
            Your Tech Career?
          </span>
        </h1>
        ...
        <p className="text-lg md:text-xl font-sans text-gray-600 mb-10 max-w-2xl mx-auto leading-relaxed">
          ...
          <span className="block mt-2 text-green-600 font-semibold">Your journey to a verified internship starts here.</span>
        </p>

        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
          <button 
            onClick={() => router.push('/signup')} 
            className="group relative bg-gradient-to-r from-green-500 to-emerald-600 cursor-pointer hover:from-green-600 hover:to-emerald-700 text-white text-lg font-semibold px-10 py-4 rounded-xl transition-all duration-300 shadow-2xl shadow-green-500/25 hover:shadow-green-500/40 hover:scale-105 overflow-hidden w-full sm:w-auto"
          >
          ...
          <button 
            ...
            className="group bg-white cursor-pointer hover:bg-gray-50 text-gray-900 text-lg font-semibold px-10 py-4 rounded-xl transition-all duration-300 border border-gray-300 hover:border-green-500 w-full sm:w-auto"
          >
        ...
        <div className="mt-16 flex justify-center gap-2">
          {[...Array(5)].map((_, i) => (
            <div
              key={i}
              className="w-2 h-2 rounded-full bg-green-500/20 animate-pulse"
