  ...
  return (
    <nav className="flex items-center justify-around bg-[#262626] text-white py-2 px-4 border-b border-neutral-800 w-full">
      ...
      <div className="flex items-center gap-2">
        <Link 
          href="/login" 
          className="px-4 py-2 text-sm font-medium text-neutral-300 transition-colors hover:bg-neutral-800 hover:text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-[#262626] focus:ring-green-500"
        >
          Login
        </Link>
        <Link
