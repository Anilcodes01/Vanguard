...
export const SuccessModal = ({
  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-gray-900 border border-[#f59120]/30 rounded-2xl p-8 text-center w-full max-w-sm relative animate-in fade-in-0 zoom-in-95 duration-500">
        ...
        <h2 className="text-3xl font-bold text-white mt-10 mb-2">
          Problem Solved!
        </h2>
