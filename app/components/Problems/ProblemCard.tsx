...
export default function ProblemCard({ problem }: { problem: Problem }) {
  return (
    <Link
      ...
      className="group flex flex-col cursor-pointer h-full bg-white rounded-2xl p-5 border  shadow-lg shadow-black/20 hover:border-green-500/50 hover:shadow-green-500/10 hover:-translate-y-1 transition-all duration-300"
    >
      <div className="flex-grow">
        <div className="flex justify-between items-start mb-2">
          <h3 className="text-base font-bold text-black group-hover:text-green-400 transition-colors pr-2">
            {problem.title}
          </h3>
          {problem.solved && (
            <CheckCircle2
  ...
  <div className="bg-white rounded-2xl p-5 border  animate-pulse">
    ...
    <div className="mt-4 pt-4 border-t border-neutral-800/50 grid grid-cols-3 gap-2">
      <div className="flex flex-col items-center gap-1">
        <div className="h-5 w-5 bg-neutral-200 rounded-full mb-1"></div>
