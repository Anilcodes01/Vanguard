...
export default function UploadProjectForm() {
  ...
  return (
    <form
      ...
      className="w-full max-w-2xl bg-[#3b3b3b] p-8 rounded-lg shadow-md space-y-6"
    >
      ...
      <div>
        ...
        <input
          ...
          id="name"
          required
          className="mt-1 block w-full bg-[#ffffff] border border-gray-600 rounded-md shadow-sm py-2 px-3 text-white focus:outline-none focus:ring-blue-500 focus:border-blue-500"
        />
      </div>
