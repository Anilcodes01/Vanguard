      ...
      <div className="bg-white rounded-2xl w-full max-w-4xl shadow-2xl border border-gray-100 animate-in fade-in zoom-in duration-200 my-8">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-100 sticky top-0 bg-white z-10 rounded-t-2xl">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">
              Share your progress, code, and screenshots.
            </p>
          </div>
          <button
            onClick={onClose}
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-gray-500">
                Describe what you built, the architecture, challenges faced, and
              ...
              <textarea
                ...
                className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-orange-500 focus:border-orange-500 outline-none transition-all text-sm font-mono"
              />
            </div>
          </form>
        </div>
        ...
        <div className="p-6 border-t border-gray-100 bg-gray-50 rounded-b-2xl flex justify-end gap-3">
          <button
            ...
            onClick={onClose}
            disabled={isSubmitting || isUploading}
            className="px-6 py-2.5 rounded-xl font-semibold text-sm text-gray-700 bg-white border border-gray-200 hover:bg-gray-50 transition-colors"
          >
            Cancel
          </button>
          <button
            ...
            disabled={isSubmitting || isUploading}
            className="flex items-center gap-2 px-8 py-2.5 rounded-xl font-semibold text-sm text-white bg-orange-600 hover:bg-orange-700 transition-all shadow-lg hover:shadow-orange-500/30 disabled:opacity-70 disabled:cursor-not-allowed"
          >
