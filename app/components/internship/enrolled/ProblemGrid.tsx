    ...
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {problems.map((problem, idx) => (
          <div 
            key={problem.id} 
            className="bg-white rounded-xl border border-gray-200 shadow-sm hover:shadow-lg hover:border-orange-200 transition-all duration-300 group flex flex-col"
          >
            ...
            <div className="p-4 border-t border-gray-100 bg-gray-50/50 rounded-b-xl flex justify-between items-center group-hover:bg-orange-50/30 transition-colors">
              <span className="text-xs font-medium text-gray-400 uppercase tracking-wider">Unsolved</span>
